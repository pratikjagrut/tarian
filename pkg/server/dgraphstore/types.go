...
type Target struct {
	...
	DetectionDataType string   `json:"target_detection_data_type,omitempty"` // Type of detection data associated with the target.
	DetectionData     string   `json:"target_detection_data,omitempty"`      // Detection data associated with the target (in JSON format).
}
